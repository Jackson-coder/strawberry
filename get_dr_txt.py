...
from nets.yolo4_tiny.yolo4_tiny import yolo_body as yolo_body_tiny, yolo_eval
...
class mAP_YOLO(YOLO):
    ...
    def generate(self):
        ...
        self.yolo_model = yolo_body_tiny(Input(shape=(None, None, 3)), num_anchors//2,
                                         num_classes) if self.pattern == 'yolo_tiny' else yolo_body(Input(shape=(None, None, 3)), num_anchors//2, num_classes)
